        ...
        if 'sarah' in url_lower or 'chen' in url_lower:
            return JsonResponse({
                ...
                "extracted_data": {
                    ...
                    "skills_data": [
                        {"name": "Python", "level": "intermediate", "description": "Experience with Django web framework and data analysis"},
                        {"name": "JavaScript", "level": "advanced", "description": "React, Node.js, and full-stack web development"},
                        {"name": "SQL", "level": "intermediate", "description": "Database design and query optimization"}
                    ]
                }
            })
        else:
            return JsonResponse({
                ...
                "extracted_data": {
                    ...
                    "program": "Engineering",
                    "skills_data": [
                        {"name": "Python", "level": "advanced", "description": "Machine learning and data science projects"},
                        {"name": "MATLAB", "level": "intermediate", "description": "Engineering simulations and analysis"}
                    ]
                }
            })
    ...
    # GitHub profile simulation
        ...
        return JsonResponse({
            ...
            "extracted_data": {
                ...
                "program": "Computer Science",
                "skills_data": [
                    {"name": "Python", "level": "expert", "description": "Open source contributions, web scraping, and automation"},
                    {"name": "JavaScript", "level": "advanced", "description": "React, Vue.js, and Node.js projects on GitHub"},
                    {"name": "Docker", "level": "intermediate", "description": "Containerization and deployment of applications"}
                ]
            }
        })
    ...
    # Personal portfolio website simulation
        ...
        return JsonResponse({
            ...
            "extracted_data": {
                ...
                "program": "Fine Arts",
                "skills_data": [
                    {"name": "Graphic Design", "level": "advanced", "description": "Adobe Creative Suite, branding, and visual identity projects"},
                    {"name": "Web Design", "level": "intermediate", "description": "HTML/CSS, responsive design, and user experience"},
                    {"name": "Photography", "level": "intermediate", "description": "Digital photography and photo editing"}
                ]
            }
        })
